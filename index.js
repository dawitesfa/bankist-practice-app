...
const navMenuBtnEl = document.querySelector(".navigation-bar__menu-icon")
...
const navLinksEl = document.querySelector(".navigation-bar__nav-links")
...
navMenuBtnEl.addEventListener("click", onMenuClickHandler)
